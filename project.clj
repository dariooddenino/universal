(defproject universal "0.1.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.8.0"]
                 ...
                 [navis/untangled-client "0.6.0"
                  :exclusions [cljsjs/react org.omcljs/om org.clojure/tools.reader]]
  ...
  :uberjar-name "universal.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main universal.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "universal.core/on-figwheel-reload"}

                :compiler {:main universal.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/universal.js"
